        ...
        <div class="panel">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <select v-if="role_user.role" class="form-control">
            ...
            <div class="form-group">
              ...
              <select v-model="role_user.user_id" class="form-control">
                <option value>Pilih</option>
                <option
                  :value="row.id"
                  :key="index"
            ...
            <div class="form-group">
              <button class="btn btn-danger btn-sm" @click.prevent="submit">Set Role</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-7">
        <div class="panel">
          ...
          <div class="panel-body">
            <div class="form-group">
              <label for>Role</label>
              <select v-model="role_selected" class="form-control">
                <option value>Pilih</option>
                <option :value="row.id" :key="index" v-for="(row, index) in roles">{{ row.name }}</option>
              </select>
            </div>
            <div class="form-group">
              <button class="btn btn-primary btn-sm">{{ loading ? 'Loading...' : 'Check'}}</button>
            </div>
            <div class="form-group">
            ...
            <div class="pull-right">
              <button class="btn btn-primary btn-sm" @cick="setPermission">
